...
export default class SettingPage extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      user_sex: this.props.navigation.state.params.user.user_sex,
      user_name: this.props.navigation.state.params.user.user_name,
      user_state: this.props.navigation.state.params.user.user_other_id,
      isDialogVisible: false,
      isInputVisible: false,
      data: {},
      file: {},
      upload: 0,
      user_face: this.props.navigation.state.params.user.user_face
    }
  }
  ...
  static navigationOptions = ({ navigation }) => ({
    ...
    <TouchableOpacity style={{ marginRight: 30 }} onPress={() => navigation.state.params.onPost()}>
      <Text style={{ color: '#ffffff', fontSize: 18, fontWeight: '500' }}>保存</Text>
    </TouchableOpacity>
  });
  ...
  render() {
    ...
    if (this.state.file.uri) {
      ...
      avatar = <Image style={styles.avatar} source={{ uri: this.props.navigation.state.params.user.user_face }} indicator={Progress.Circle} />
    }
    ...
    return (
      <View style={styles.container}>
        ...
        <View
          ...
          <TextPingFang style={styles.avatar_font}>{this.props.navigation.state.params.user.user_code}</TextPingFang>
        </View>
        <TouchableOpacity
          onPress={() => {
            this.changeName()
